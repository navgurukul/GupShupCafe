...
def main():
    ...
    When asked to perform calculations, use the appropriate tool rather than calculating the result yourself. However, use your knowledge of mathematical terms.
    EXPLAIN THE CALCULATION STEP-BY-STEP and show the result clearly.
    """
    ...
    with streamable_http_mcp_client:
        ...
        agent = GeminiAgent(system_prompt=system_prompt, tools=tools)
