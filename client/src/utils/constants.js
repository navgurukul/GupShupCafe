...
export const ERROR_MESSAGES = {
  MIC_PERMISSION_DENIED: 'Microphone access denied. Please enable it in your browser settings.',
  MIC_NOT_FOUND: 'No microphone found. Please connect a microphone and try again.',
  SOCKET_CONNECTION_FAILED: 'Failed to connect to server. Please check your internet connection.',
  ROOM_JOIN_FAILED: 'Failed to join room. Please try again.',
  WEBRTC_CONNECTION_FAILED: 'Failed to establish audio connection. Please check your network settings.',
